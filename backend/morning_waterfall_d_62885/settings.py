"""
Django settings for morning_waterfall_d_62885 project.
...
ROOT_URLCONF = 'morning_waterfall_d_62885.urls'
...
WSGI_APPLICATION = 'morning_waterfall_d_62885.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_waterfall_d_62885 API",
    "DESCRIPTION": "API documentation for morning_waterfall_d_62885 App",
    "VERSION": "v1",
}
