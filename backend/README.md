...
## Project Structure
    ...
    ├── morning_waterfall_d_62885  # Django project configurations
...
1. Clone this repo and `cd morning_waterfall_d_62885`
...
2. Clone this repo and `cd morning_waterfall_d_62885`
